...
static PyObject *rlist_list(PyObject *self, PyObject* args){
    ...
    PyArrayObject *species, *exclude, *reactions;
    int ndspecies, ndexclude, ndreactions;
    npy_intp *dspecies, *dexclude, *dreactions;
    long int *speciesptr, *excludeptr, *reactionsptr;
    if (!PyArg_ParseTuple(args, "O!O!O!", &PyArray_Type, &species,  &PyArray_Type, &exclude, &PyArray_Type, &reactions)) return NULL;
